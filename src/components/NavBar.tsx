                ...
                <div className="container flex flex-wrap h-14 items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <div className="ml-6 hidden md:block">
                            <nav className="flex items-center gap-6 font-medium text-sm">
                                <a href="" className="hover:text-amber-400 transition-colors">Tutors</a>
                                ...
                                <a href="" className="hover:text-amber-400 transition-colors">Dummy</a>
                            </nav>
                        </div>
                    </div>
                    <div className="hidden md:block">
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                className="p-2 inline-flex items-center justify-center text-sm text-gray-900 bg-amber-400 hover:bg-amber-500 rounded transition duration-150 font-semibold">Sign Up
                            </button>
                        </div>
                    </div>
                </div>
